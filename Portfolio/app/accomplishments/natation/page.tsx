            ...
            {natationImages.map((imageData, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div 
                    className="relative flex-shrink-0 w-full md:w-[28%] cursor-pointer group"
                    onClick={() => setSelectedImage(imageData.filename)}
                  >
                    {/* Épingle/Bombelle en haut */}
                    <div 
                      className={`absolute top-0 ${isLeft ? 'left-8' : 'right-8'} z-20 transform -translate-y-1/2`}
                    >
                      <Image
                        src="/epingle.png"
                        alt="Épingle"
                  ...
                  <div className={`flex-1 space-y-4 pt-8 ${isLeft ? 'md:pl-4' : 'md:pr-4'}`}>
                    ...
                    {imageData.description && (
                      <div className="space-y-2 pt-2">
                        ...
                        <p className="text-pine-600 leading-relaxed text-base">
                          {imageData.description}
                        </p>
                      </div>
                    )}
